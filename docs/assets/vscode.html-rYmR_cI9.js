import{_ as i,r as l,o as d,c as t,b as e,d as s,e as r,a as n}from"./app-QlNul8DB.js";const c={},o=n(`<h1 id="vscode" tabindex="-1"><a class="header-anchor" href="#vscode"><span>vscode</span></a></h1><h2 id="remote-ssh-服务器pem权限设置" tabindex="-1"><a class="header-anchor" href="#remote-ssh-服务器pem权限设置"><span>remote-ssh 服务器pem权限设置</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>    右键 属性 安全 高级 禁用继承 选第二项 然后添加administrator
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="离线版扩展" tabindex="-1"><a class="header-anchor" href="#离线版扩展"><span>离线版扩展</span></a></h2><h3 id="下载" tabindex="-1"><a class="header-anchor" href="#下载"><span>下载</span></a></h3>`,5),v={href:"https://marketplace.visualstudio.com/vscode",target:"_blank",rel:"noopener noreferrer"},h=e("code",null,"Download Extension",-1),m=n(`<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h3><p><code>vscode中打开扩展-&gt;右上角三个点-&gt;从VSIX安装</code></p><h2 id="光标" tabindex="-1"><a class="header-anchor" href="#光标"><span>光标</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>    vscode 同时编辑多处，多个光标 快捷键
    一、重命名变量
