import{_ as a,r as e,o as t,c as i,b as n,d as l,e as c,a as o}from"./app-DLNTDXQM.js";const p={},r=n("h1",{id:"nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx"},[n("span",null,"nginx")])],-1),d=n("h2",{id:"需要阅读的文档",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#需要阅读的文档"},[n("span",null,"需要阅读的文档")])],-1),u={href:"https://nginx.org/en/docs/",target:"_blank",rel:"noopener noreferrer"},v=o(`<h2 id="nginx-service" tabindex="-1"><a class="header-anchor" href="#nginx-service"><span>nginx.service</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>Unit<span class="token punctuation">]</span>
