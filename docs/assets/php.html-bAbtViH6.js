import{_ as t,r as i,o as l,c as o,b as n,d as s,e as p,a}from"./app-CELWb2CF.js";const c={},u=a(`<h1 id="php" tabindex="-1"><a class="header-anchor" href="#php"><span>php</span></a></h1><h2 id="php安装" tabindex="-1"><a class="header-anchor" href="#php安装"><span>PHP安装</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>    <span class="token number">1</span>.  安装epel的yum源 
