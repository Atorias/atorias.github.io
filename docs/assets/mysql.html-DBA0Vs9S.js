import{_ as a,r as e,o as l,c as i,b as s,d as t,e as r,a as c}from"./app-CELWb2CF.js";const d={},p=s("h1",{id:"mysql",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#mysql"},[s("span",null,"MYSQL")])],-1),o=s("h2",{id:"下载地址",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#下载地址"},[s("span",null,"下载地址")])],-1),m={href:"https://dev.mysql.com/downloads/mysql/",target:"_blank",rel:"noopener noreferrer"},u=c(`<h2 id="创建数据库并授权用户" tabindex="-1"><a class="header-anchor" href="#创建数据库并授权用户"><span>创建数据库并授权用户</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
